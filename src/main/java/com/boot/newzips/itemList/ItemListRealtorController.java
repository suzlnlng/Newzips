...
public class ItemListRealtorController {
    ...
    @GetMapping(value = "/newzips/realtor/itemList")
    public ModelAndView itemList_user(Model model) throws Exception {
        ...
        mav.setViewName("realtor/itemList_realtor");

        return mav;
    }

    @PostMapping(value = "/newzips/realtor/itemList")
    public ModelAndView itemList_user(Model model, @RequestParam("start") int start,
        ...
        mav.setViewName("realtor/listing_user");
